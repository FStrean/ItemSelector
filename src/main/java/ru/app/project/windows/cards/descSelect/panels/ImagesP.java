...
import ru.app.project.design.descSelect.impl.panels.BasicImagesPDBuilder;
import ru.app.project.design.descSelect.interf.panels.ImagesPDBuilder;
...
public class ImagesP extends JPanel implements BasicPanel {
    ...
    public void applyDesign() {
        List<JImage> jImages = new ArrayList<>(AppProperties.getMaxNumOfImgInDescSelect());
