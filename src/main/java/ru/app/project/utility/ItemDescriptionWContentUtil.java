...
public class ItemDescriptionWContentUtil {
    ...
    private ItemDescriptionWStateConfig getDefaultConfig() {
        return new ItemDescriptionWStateConfig(new ArrayList<>(AppProperties.getMaxNumberOfImagesInItemDescriptionWindow()));
    }
}
